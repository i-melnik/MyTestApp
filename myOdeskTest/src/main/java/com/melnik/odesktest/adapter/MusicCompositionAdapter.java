...
public class MusicCompositionAdapter implements ListAdapter
{
	...
	public MusicCompositionAdapter(Context context, List<MusicItem> data)
	{
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		else
		{
			...
			holder.count.setText(item.getArtist() == null ? "" : item.getArtist());
		}
		return convertView;
	}
